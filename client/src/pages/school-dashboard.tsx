...
//years here remember to add more down to 2000 and also add a search bar to search for a specific year
  ...
  const mockYears = !school || isPurchaseDataLoading ? [] : (() => {
    ...
    // Use the actual founding year, with minimum of 1999 if school was founded before 1999
    const startYear = (schoolFoundingYear && schoolFoundingYear < 1999) ? 1999 : (schoolFoundingYear || 1999);
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent className="bg-blue-600/60 backdrop-blur-lg border border-white/20">
                          ...
                          {(() => {
                            const foundingYear = school?.yearFounded || 1999;
                            const years: number[] = [];
