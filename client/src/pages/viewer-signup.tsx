      ...
      <div className="w-full max-w-2xl relative z-10">
        <Card className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl">
          <CardHeader className="text-center">
            ...
            <div className="mt-4 p-3 bg-amber-900/30 border border-amber-600/40 rounded-lg">
              <p className="text-xs text-amber-200">
                ⚠️ <strong>Testing Phase:</strong> All accounts created during testing will be automatically deleted after 30 days.
              </p>
            </div>
          </CardHeader>
